...
public class Schedule implements ScheduleI {
	...
	public Schedule(ActivitiesEnum value1, ActivitiesEnum value2, ActivitiesEnum value3, ActivitiesEnum value4) {
		...
		if (value1 == ActivitiesEnum.CIW_BUS || value1 == ActivitiesEnum.CIW_FOOT
				|| value1 == ActivitiesEnum.MOUNTAINVIEW_BUS || value1 == ActivitiesEnum.MOUNTAINVIEW_FOOT) {
			setCafeteria(value1);
			...
			setBuilding(value1);
				...
				|| value1 == ActivitiesEnum.CS350_BUS || value1 == ActivitiesEnum.CS350_FOOT) {
			setLecture(value1);
		} else {
		...
		if (value2 == ActivitiesEnum.CIW_BUS || value2 == ActivitiesEnum.CIW_FOOT
				|| value2 == ActivitiesEnum.MOUNTAINVIEW_BUS || value2 == ActivitiesEnum.MOUNTAINVIEW_FOOT) {
			setCafeteria(value2);
			...
			setBuilding(value2);
				...
				|| value2 == ActivitiesEnum.CS350_BUS || value2 == ActivitiesEnum.CS350_FOOT) {
			setLecture(value2);
		} else {
			System.out.println("invalid arugument 1");
			System.exit(0);
		...
		if (value3 == ActivitiesEnum.CIW_BUS || value3 == ActivitiesEnum.CIW_FOOT
				|| value3 == ActivitiesEnum.MOUNTAINVIEW_BUS || value3 == ActivitiesEnum.MOUNTAINVIEW_FOOT) {
			setCafeteria(value3);
			...
			setBuilding(value3);
				...
				|| value3 == ActivitiesEnum.CS350_BUS || value3 == ActivitiesEnum.CS350_FOOT) {
			setLecture(value3);
		} else {
			System.out.println("invalid arugument 1");
			System.exit(0);
		...
		if (value4 == ActivitiesEnum.CIW_BUS || value4 == ActivitiesEnum.CIW_FOOT
				|| value4 == ActivitiesEnum.MOUNTAINVIEW_BUS || value4 == ActivitiesEnum.MOUNTAINVIEW_FOOT) {
			setCafeteria(value4);
			...
			setBuilding(value4);
				...
				|| value4 == ActivitiesEnum.CS350_BUS || value4 == ActivitiesEnum.CS350_FOOT) {
			setLecture(value4);
		} else {
			System.out.println("invalid arugument 1");
			System.exit(0);
